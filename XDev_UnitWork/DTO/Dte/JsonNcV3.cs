...
namespace XDev_UnitWork.DTO.Dte
{
    public class JsonNcV3
    {
        ...
        public FeNcV3EmisorDTO emisor { get; set; } = new FeNcV3EmisorDTO();
        public FeNcV3ReceptorDTO receptor { get; set; } = new FeNcV3ReceptorDTO();
        public FeVentaTerceroDTO ventaTercero { get; set; } = null;
        public List<FeNcV3DetailDTO> cuerpoDocumento { get; set; } = new List<FeNcV3DetailDTO>();
        public FeNcV3SummaryDTO resumen { get; set; } = new FeNcV3SummaryDTO();
        public FeNcV3ExtensionDTO extension { get; set; } = new FeNcV3ExtensionDTO();
        public List<FeAppendixDTO> apendice { get; set; } = null;
    }

    public class FeNcV3EmisorDTO
    {
    ...
    public class FeNcV3ExtensionDTO
    {
    ...
    public class FeNcV3ReceptorDTO
    {
        public string nit { get; set; }
        public string nrc { get; set; }
        public string nombre { get; set; }
