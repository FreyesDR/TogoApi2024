...
{
    public class InvoicePositionConditionConfig : IEntityTypeConfiguration<InvoicePositionCondition>
    {
        public void Configure(EntityTypeBuilder<InvoicePositionCondition> builder)
        {
            builder.HasKey(k => new { k.InvoicePositionId, k.PriceConditionId });
