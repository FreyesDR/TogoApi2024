...
namespace XDev_Model.Configuration
{
    public class InvoiceConfig : IEntityTypeConfiguration<Invoice>
    {
        public void Configure(EntityTypeBuilder<Invoice> builder)
        {
            ...
            builder.HasIndex(p => p.CodGeneracion).IsUnique();
            ...
            builder.Property(p => p.CanceledUserId).HasMaxLength(50);
            builder.Property(p => p.CodGeneracion).HasMaxLength(50);
            builder.Property(p => p.EBillingDoc).HasMaxLength(4);
            builder.Property(p => p.NumControl).HasMaxLength(50);
            builder.Property(p => p.SelloRecepcion).HasMaxLength(50);
            ...
            builder.HasOne(o => o.InvoiceSporadicPartner)
                .WithOne(o => o.Invoice)
                .HasForeignKey<InvoiceSporadicPartner>(f => f.InvoiceId)
                .OnDelete(DeleteBehavior.Cascade);
            ...
            builder.Navigation(n => n.InvoiceType)
