...
namespace XDev_Model.Migrations
{
    ...
    [Migration("20250114201830_14012025-2")]
    partial class _140120252
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XDev_Model.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            ConcurrencyStamp = "643e262c-ccc4-4932-9c0f-e99937ca61f3",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            SecurityStamp = "a872cd3b-5010-4091-a2b3-06d59c2ab087",
            ...
            modelBuilder.Entity("XDev_Model.Entities.MaterialWareHouse", b =>
                {
                    ...
                    b.Property<Guid>("MaterialBranchId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("XDev_Model.Entities.MaterialBranch", b =>
                {
                    b.HasOne("XDev_Model.Entities.Branch", "Branch")
                        .WithMany("MaterialBranches")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("XDev_Model.Entities.Material", "Material")
                        .WithMany("MaterialBranches")
            ...
            modelBuilder.Entity("XDev_Model.Entities.MaterialWareHouse", b =>
                {
                    b.HasOne("XDev_Model.Entities.MaterialBranch", "MaterialBranch")
                        .WithMany("MaterialWareHouse")
                        .HasForeignKey("MaterialBranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MaterialBranch");
                });
