...
namespace XDev_Model.Migrations
{
    ...
    [Migration("20250731134111_31072025")]
    partial class _31072025
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XDev_Model.Entities.AccountCatalog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AccountCatalog");
                });

            modelBuilder.Entity("XDev_Model.Entities.AccountType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XDev_Model.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            ConcurrencyStamp = "d82652dd-981e-43d8-af28-9e636ba3be55",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            SecurityStamp = "e61ce27a-285f-4cb3-8d32-f31f8319cf15",
            ...
            modelBuilder.Entity("XDev_Model.Entities.EBillingCompany", b =>
                {
                    ...
                    b.Property<byte[]>("CertPrd")
                        .HasColumnType("bytea");

                    b.Property<byte[]>("CertTest")
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("XDev_Model.Entities.Journal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XDev_Model.Entities.JournalType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XDev_Model.Entities.AccountCatalog", b =>
                {
                    b.HasOne("XDev_Model.Entities.AccountType", "AccountType")
                        .WithMany("Catalogs")
                        .HasForeignKey("AccountTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("XDev_Model.Entities.AccountCatalog", "ParentCatalog")
                        .WithMany("ChildrenCatalog")
            ...
            modelBuilder.Entity("XDev_Model.Entities.Journal", b =>
                {
                    b.HasOne("XDev_Model.Entities.JournalType", "JournalType")
                        .WithMany("Journals")
